...
class WbReportDetailByPeriodJob implements ShouldQueue
{
        ...
        if($response['result']) {
            ...
            if($response['result']) {
                ...
                foreach($response['data'] as $item) { 
                    $wb_item = new WbReportDetailByPeriod();
            ...
            WbReportDetailByPeriodJob::dispatch($this->dateFrom)->delay(now()->addMinutes(1));
        }    
    }
}
